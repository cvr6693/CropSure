...
# def display_disease_info(crop_disease_key):
#     disease_info = {
...
#    development is favored by wet, cool weather that generally occurs in spring 
#    and early summer.
# 2. Fungal spores are carried by wind, rain, or splashing water from the ground 
#    to flowers, leaves, or fruit. During damp or rainy periods, newly opening 
#    apple leaves are extremely susceptible to infection. The longer the leaves 
#    remain wet, the more severe the infection will be. Apple scab spreads rapidly 
#    between 55-75°F.

# How to prevent/cure the disease:
# 1. Choose resistant varieties when possible.
# 2. Rake under trees and destroy infected leaves to reduce the number of fungal 
#    spores available to start the disease cycle over again next spring.
# 3. Water in the evening or early morning hours (avoid overhead irrigation) to 
#    give the leaves time to dry out before infection can occur.
# 4. Spread a 3- to 6-inch layer of compost under trees, keeping it away from the 
#    trunk, to cover soil and prevent splash dispersal of the fungal spores.
# """,
...
# The fungus can infect dead tissue as well as living trunks, branches, leaves, 
# and fruits. In wet weather, spores are released from these infections and spread 
# by wind or splashing water. The fungus infects leaves and fruit through natural 
# openings or minor wounds.

# How to prevent/cure the disease:
# 1. Prune out dead or diseased branches.
# 2. Remove infected plant material from the area.
# 3. Be sure to remove the stumps of any apple trees you cut down. Dead stumps 
#    can be a source of spores.
# """,
#         'Apple___Cedar_apple_rust': """Crop:         Apple
# Disease:      Cedar Apple Rust

# Cause of disease:
# Cedar apple rust (*Gymnosporangium juniperi-virginianae*) is a fungal disease 
# that depends on two species to spread and develop. It spends a portion of its 
# two-year life cycle on Eastern red cedar (*Juniperus virginiana*). The pathogen’s 
# spores develop in late fall on the juniper as a reddish brown gall on young 
# branches of the trees.

# How to prevent/cure the disease:
# 1. Since the juniper galls are the source of the spores that infect the apple 
#    trees, cutting them is a sound strategy if there aren’t too many of them.
# 2. While the spores can travel for miles, most of the ones that could infect 
#    your tree are within a few hundred feet.
# 3. The best way to do this is to prune the branches about 4-6 inches below the galls.
# """,
#         'Apple___healthy': """Crop:         Apple
# Disease:      No Disease

# Great news! Your crop is **healthy**. Keep up the good work!
# """
...
# Cause of disease:
# Podosphaera clandestina, a fungus that most commonly infects young, expanding 
# leaves but can also be found on buds, fruit, and fruit stems. It overwinters 
# as small, round, black bodies (chasmothecia) on dead leaves, on the orchard 
# floor, or in tree crotches. Colonies produce more (asexual) spores generally 
# around shuck fall and continue the disease cycle.

# How to prevent/cure the disease:
# 1. Remove and destroy sucker shoots.
# 2. Keep irrigation water off developing fruit and leaves by using irrigation 
#    that does not wet the leaves. Also, keep irrigation sets as short as possible.
# 3. Follow cultural practices that promote good air circulation, such as pruning 
#    and moderate shoot growth through judicious nitrogen management.
# """,
...
#         'Corn_(maize)___Cercospora_leaf_spot Gray_leaf_spot': """Crop:         Corn (Maize)
# Disease:      Gray Leaf Spot

# Cause of disease:
# Gray leaf spot lesions on corn leaves hinder photosynthetic activity, reducing 
# carbohydrates allocated towards grain fill. The extent of damage depends on 
# leaf infection relative to grain fill. Damage can be more severe when lesions 
# progress past the ear leaf around pollination time. Because a decrease in 
# functioning leaf area limits photosynthesis for grain fill, the plant may 
# mobilize more carbohydrates from the stalk to fill kernels.

# How to prevent/cure the disease:
# 1. Reduce the rate of disease growth and expansion.
# 2. Limit the number of secondary disease cycles and protect leaf area from 
#    damage until after corn grain formation.
# 3. High-risk factors for gray leaf spot:
#    a. Susceptible hybrid
#    b. Continuous corn
#    c. Late planting date
#    d. Minimum tillage systems
...
# Cause of disease:
# Common rust in corn is caused by the fungus *Puccinia sorghi*. This disease 
# rarely causes significant yield losses in Ohio field corn, but severe 
# infections can occur under favorable weather conditions.

# How to prevent/cure the disease:
# 1. Most field corn hybrids possess some degree of resistance, reducing the 
#    need for fungicide applications.
# 2. Popcorn and sweet corn are more susceptible, and an early fungicide 
#    application may be necessary in seasons with significant rust presence 
#    before silking.
# 3. Numerous fungicides are available for rust control.
# """,
...
# Cause of disease:
# Northern corn leaf blight (NCLB) is a foliar disease of corn caused by 
# *Exserohilum turcicum* (anamorph of the ascomycete *Setosphaeria turcica*). 
# Characterized by cigar-shaped lesions, this disease can cause significant 
# yield loss in susceptible corn hybrids.

# How to prevent/cure the disease:
# 1. Management of NCLB is primarily achieved by using hybrids with resistance.
# 2. Since resistance may not be complete, an integrated approach with cropping 
#    practices and fungicides is recommended.
# 3. Scouting fields and monitoring local conditions is vital to control this disease.
# """,
...
# Cause of disease:
# 1. The black rot fungus overwinters in canes, tendrils, and leaves on the grapevine and on the ground.
# 2. During rain, microscopic spores are carried by air currents to young, expanding leaves.
# 3. Infection becomes visible after 8 to 25 days and can persist throughout spring and summer.

# How to prevent/cure the disease:
# 1. Ensure proper spacing of vines for sunlight and air circulation.
# 2. Keep planting areas free of weeds and tall grass.
# 3. Use protective fungicide sprays such as copper, captan, mancozeb, and ziram at critical growth stages.
# """,
...
# Cause of disease:
# 1. Caused by multiple fungi, primarily *Phaeoacremonium* and *Phaeomoniella* species.
# 2. Spores are released during fall to spring rainfall and infect pruning wounds.

# How to prevent/cure the disease:
# 1. Use preventative practices like delayed pruning and pruning-wound protectants.
# 2. Remove diseased vine portions and destroy woody debris.
# 3. Consider alternative wound sealants with boric acid or essential oils.
# """,
...
# Cause of disease:
# 1. The fungus overwinters in fallen leaves and soil, thriving in wet, cool weather.
# 2. Spores are spread by wind, rain, or splashing water.

# How to prevent/cure the disease:
# 1. Choose resistant grape varieties when possible.
# 2. Remove and destroy infected leaves to break the disease cycle.
# 3. Water in the morning or evening to allow leaves to dry before infection can occur.
# 4. Apply compost under trees to prevent spore dispersal.
# """,
...
# Cause of disease:
# 1. Caused by *Candidatus Liberibacter* spp., affecting fruit development and quality.
# 2. Spread by the Asian citrus psyllid.

# How to prevent/cure the disease:
# 1. Remove infected trees to prevent further spread.
# 2. Control psyllid populations through pesticides and biological methods.
# 3. Use foliar nutritional sprays to reduce fruit drop.
# """,
...
# Cause of disease:
# 1. Caused by multiple *Xanthomonas* species.
# 2. Bacteria spread through water and invade wet plant tissue.

# How to prevent/cure the disease:
# 1. Use pathogen-free seeds and disease-free transplants.
# 2. Minimize overwatering and handling of wet plants.
# 3. Sanitize trays, tools, and greenhouse structures between crop cycles.
# 4. Avoid spraying or handling plants when wet.
# """,

#         'Pepper,_bell___Bacterial_spot': """Crop:         Bell Pepper
# Disease:      Bacterial Spot

# Cause of disease:
# 1. Caused by multiple *Xanthomonas* species.
# 2. Bacteria produce yellow, mucoid colonies and spread through water.

# How to prevent/cure the disease:
# 1. Use certified pathogen-free seeds and disease-free transplants.
# 2. Practice crop rotation to prevent bacterial buildup.
# 3. Apply copper-based bactericides to protect foliage and fruit.
# """,
...
#         'Potato___Early_blight': """ <b>Crop</b>: Potato <br/>Disease: Early Blight<br/>
#         <br/> Cause of disease:
#         <br/><br/> 1. Early blight (EB) is caused by the fungus *Alternaria solani*. 
#         <br/> 2. The disease primarily affects leaves and stems, leading to defoliation.
#         <br/> 3. Can cause yield reduction if uncontrolled.
#         <br/><br/> How to prevent/cure the disease: <br/>
#         <br/>1. Use certified disease-free seeds. 
#         <br/>2. Apply a regular foliar fungicide spray program.
#         <br/>3. Allow tubers to mature before harvesting.
#         """,

#         'Potato___Late_blight': """ <b>Crop</b>: Potato <br/>Disease: Late Blight<br/>
#         <br/>Cause of disease:
#         <br/><br/> 1. Caused by the oomycete *Phytophthora infestans*.
#         <br/> 2. Can infect leaves, stems, and fruits.
#         <br/> 3. Responsible for the Irish potato famine of the 1840s.
#         <br/><br/> How to prevent/cure the disease: <br/>
#         <br/>1. Inspect tomato transplants for symptoms before planting.
#         <br/>2. Remove infected plants immediately to prevent spreading.
#         <br/>3. Use disease-resistant varieties.
#         """,

#         'Squash___Powdery_mildew': """ <b>Crop</b>: Squash <br/>Disease: Powdery Mildew<br/>
#         <br/> Cause of disease:
#         <br/><br/> 1. Favors humid conditions with temperatures around 68-81°F.
#         <br/> 2. Symptoms appear mid to late summer.
#         <br/> 3. Wind spreads spores from infected leaves.
#         <br/><br/> How to prevent/cure the disease: <br/>
#         <br/>1. Apply fertilizer based on soil test results.
#         <br/>2. Provide good air circulation through proper spacing.
#         <br/>3. Regularly monitor leaves for infection.
#         """,

#         'Strawberry___Leaf_scorch': """ <b>Crop</b>: Strawberry <br/>Disease: Leaf Scorch<br/>
#         <br/> Cause of disease:
#         <br/><br/> 1. Caused by the fungus *Diplocarpon earliana*.
#         <br/> 2. Initially appears as small purplish spots on leaves.
#         <br/><br/> How to prevent/cure the disease: <br/>
#         <br/>1. Remove infected leaves to prevent further spread.
#         <br/>2. Maintain proper garden sanitation.
#         <br/>3. Avoid overwatering and ensure good drainage.
#         """,

#         'Tomato___Bacterial_spot': """ <b>Crop</b>: Tomato <br/>Disease: Bacterial Spot<br/>
#         <br/> Cause of disease:
#         <br/><br/> 1. Caused by *Xanthomonas* bacteria.
#         <br/> 2. Moves in water and infects wet plant tissue.
#         <br/><br/> How to prevent/cure the disease: <br/>
#         <br/>1. Use pathogen-free certified seeds.
#         <br/>2. Avoid handling wet plants.
#         <br/>3. Disinfect greenhouse tools and equipment.
#         """,
...
# 2. Alternaria tomatophila is more virulent on tomato than A. solani. However, if A. tomatophila is absent, A. solani will cause early blight on tomato.
...
# 4. Fertilize properly to maintain vigorous plant growth.
...
# 2. There are many different strains of *P. infestans*. Some affect both tomato and potato, while others are specific to one host.
# 3. The host range is typically limited to potato and tomato, but related weeds may also become infected.

# How to prevent/cure the disease:
# 1. Monitor for early symptoms and apply fungicides as necessary.
# 2. Remove and destroy infected plants.
# 3. Avoid overhead irrigation to minimize leaf wetness.
# 4. Use resistant tomato varieties when available.
# """,
...
# Cause of disease:
# 1. Leaf mold is caused by the fungus *Passalora fulva*.
# 2. Leaf spots grow together, turn brown, and leaves wither but remain attached.
# 3. Fruit infections start as smooth black irregular areas, which become sunken, dry, and leathery.

# How to prevent/cure the disease:
# 1. Use drip irrigation and avoid wetting foliage.
# 2. Space plants to allow good air movement.
# 3. Stake, string, or prune to increase airflow.
# 4. Sterilize stakes, ties, and trellises.
# 5. Maintain greenhouse conditions to avoid high humidity.
# 6. Remove and properly dispose of crop residue.
# """,
...
# Cause of disease:
# Septoria leaf spot is caused by the fungus *Septoria lycopersici*. It is a major disease in humid conditions.
...
# 2. This virus transmission has a short acquisition access period of 15–20 minutes and a latent period of 8–24 hours.
...
# 2. Insecticides should be alternated or mixed to provide the most effective treatment against virus transmission.
# 3. Other control methods include planting resistant/tolerant lines, crop rotation, and breeding for resistance.
# 4. One of the most promising methods to control TYLCV is the production of transgenic tomato plants resistant to TYLCV.
# """,
...
# Cause of disease:
# 1. Tomato mosaic virus and tobacco mosaic virus can persist for two years in dry soil or leaf debris, but only one month if soil is moist.
# 2. The viruses can survive in infected root debris in the soil for up to two years.
# 3. Seed can be infected and pass the virus to the plant, but the disease is primarily introduced and spread through human activity.
# 4. The virus can spread between plants via workers' hands, tools, and clothes during routine activities like plant tying, removing suckers, and harvesting.
# 5. The virus can even survive the tobacco curing process and spread from cigarettes or tobacco products handled by workers.

# How to prevent/cure the disease:
# 1. Purchase transplants only from reputable sources with proper sanitation procedures.
# 2. Inspect transplants before purchase and choose only those showing no symptoms.
# 3. Avoid planting in fields where tomato root debris is present, as the virus can survive long-term in roots.
# 4. Wash hands with soap and water before and during handling plants to reduce potential spread between plants.
# """
#     }

#     # Print formatted output
#     print("=" * 80)
#     print(f"{'Disease Detection Result':^80}")
#     print("=" * 80)
    
#     if crop_disease_key in disease_info:
#         print(disease_info[crop_disease_key])
#     else:
#         print("No information available for the selected crop-disease combination.")

#     print("=" * 80)

# # # Example usage:
# # # Change the argument to test different cases
# # display_disease_info('Apple___Apple_scab')
# # display_disease_info('Apple___Black_rot')
# # display_disease_info('Apple___Cedar_apple_rust')
# # display_disease_info('Apple___healthy')
# # display_disease_info('Blueberry___healthy')
# # display_disease_info('Cherry_(including_sour)___Powdery_mildew')
# # display_disease_info('Cherry_(including_sour)___healthy')
# # display_disease_info('Corn_(maize)___Cercospora_leaf_spot Gray_leaf_spot')
# # display_disease_info('Corn_(maize)___Common_rust_')
# # display_disease_info('Corn_(maize)___Northern_Leaf_Blight')
# # display_disease_info('Grape___Black_rot')
# # display_disease_info('Grape___Esca_(Black_Measles)')
# # display_disease_info('Grape___Leaf_blight_(Isariopsis_Leaf_Spot)')
# # display_disease_info('Grape___healthy')
# # display_disease_info('Orange___Haunglongbing_(Citrus_greening)')
# # display_disease_info('Peach___Bacterial_spot')
# # display_disease_info('Pepper,_bell___Bacterial_spot')
# # display_disease_info('Peach___healthy')
# # display_disease_info('Pepper,_bell___healthy')
# # display_disease_info('Potato___healthy')
# # display_disease_info('Raspberry___healthy')
# # display_disease_info('Soybean___healthy')
# # display_disease_info('Strawberry___healthy')
# # display_disease_info('Tomato___healthy')
# # display_disease_info('Potato___Early_blight')
# # display_disease_info('Potato___Late_blight')
# # display_disease_info('Squash___Powdery_mildew')
# # display_disease_info('Strawberry___Leaf_scorch')
# # display_disease_info('Tomato___Bacterial_spot')
# # display_disease_info('Tomato___Early_blight')
# # display_disease_info('Tomato___Late_blight')
# # display_disease_info('Tomato___Leaf_Mold')
# # display_disease_info('Tomato___Septoria_leaf_spot')
# # display_disease_info('Tomato___Spider_mites Two-spotted_spider_mite')
# # display_disease_info('Tomato___Target_Spo')
# # display_disease_info('Tomato___Tomato_Yellow_Leaf_Curl_Virus')
# # display_disease_info('Tomato___Tomato_mosaic_virus')